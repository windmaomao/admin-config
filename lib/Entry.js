...
/**
 * Entry holds one entity record specified by fields definition.
 * Each entry is identified by an unqiue identifier value.
 * Entry can be assigned from an object record, ex. from Rest call
 * Entry should conform to the fields definition if given.
 */ 
class Entry {
